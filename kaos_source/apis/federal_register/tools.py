...
class FRSearchTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.federal_register.client import search_documents
...
class FRGetDocumentTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.federal_register.client import get_document
        from kaos_source.settings.federal_register import KaosSourceFRSettings
...
class FRAgenciesTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.federal_register.client import get_agencies
        from kaos_source.settings.federal_register import KaosSourceFRSettings
