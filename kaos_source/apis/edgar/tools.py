...
class EdgarSearchTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.edgar.client import search_filings
...
class EdgarCompanyTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.edgar.client import get_company
        from kaos_source.settings.edgar import KaosSourceEdgarSettings
...
class EdgarLookupTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.edgar.client import lookup_ticker
        from kaos_source.settings.edgar import KaosSourceEdgarSettings
