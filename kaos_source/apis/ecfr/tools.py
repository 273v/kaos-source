...
class ECFRListTitlesTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.ecfr.client import get_titles
...
class ECFRStructureTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.ecfr.client import get_latest_date, get_title_structure
        from kaos_source.settings.ecfr import KaosSourceECFRSettings
...
class ECFRContentTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.apis.ecfr.client import get_latest_date, get_section_content
        from kaos_source.settings.ecfr import KaosSourceECFRSettings
