...
Requires API key: set KAOS_SOURCE_GOVINFO_API_KEY or GOVINFO_API_KEY.
...
class GovInfoSearchTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.connectors.govinfo import KaosSourceGovInfoSettings, search
...
class GovInfoGetPackageTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.connectors.govinfo import KaosSourceGovInfoSettings, get_package
...
class GovInfoCollectionsTool(KaosTool):
    ...
    async def execute(
        ...
        from kaos_source.connectors.govinfo import KaosSourceGovInfoSettings, get_collections
