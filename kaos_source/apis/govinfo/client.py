"""Async client functions for the GovInfo (US GPO) public REST API.

Requires API key: ``KAOS_SOURCE_GOVINFO_API_KEY`` (or legacy
...
Configuration via :class:`KaosSourceGovInfoSettings` (env prefix
``KAOS_SOURCE_GOVINFO_``).
